...
const justinEmail = 'wick.justin.l@gmail.com'
    ...
    <body>
      <div class="container">
        <div class="email-content">
          ...
          <div class="content">
            <p>Hey there,</p>
            <p>Canon here, founder of DoorIQ. I wanted to personally welcome you to DoorIQ and thank you for joining us!</p>
...
async function sendWelcomeEmail() {
  try {
    ...
    console.log(`📧 Sending welcome email to ${justinEmail}...`)
    ...
    console.log(`📧 Sent to: ${justinEmail}`)
  } catch (error) {
