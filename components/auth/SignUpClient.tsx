    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-gradient-to-br from-[#07030f] via-[#0e0b1f] to-[#150c28]">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/[0.06] backdrop-blur-xl p-8 shadow-[0_30px_120px_rgba(109,40,217,0.35)]">
          <p className="text-sm font-semibold text-white mb-3">Create Your Account</p>
          <p className="text-xs text-slate-300 leading-relaxed mb-6">Join DoorIQ Training to track progress, compete on leaderboards, and unlock all features.</p>
          ...
          <form onSubmit={handleSignUp} className="w-full space-y-3 mt-4">
            <div className="relative">
