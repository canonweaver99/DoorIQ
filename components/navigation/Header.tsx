...
function HeaderContent() {
  ...
  return (
    <>
      ...
      <div className={`hidden md:flex fixed top-4 left-1/2 -translate-x-[50%] z-50 items-center space-x-4 rounded-full border border-white/10 bg-black/80 backdrop-blur-xl ${isSignedIn ? 'pl-6 pr-[80px]' : 'pl-6 pr-6'} py-2 shadow-lg shadow-purple-500/10 transition-opacity duration-300 ${
