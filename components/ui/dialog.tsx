  ...
  ({ className, children, ...props }, ref) => (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          'fixed left-[50%] top-[50%] z-50 grid w-full max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 border border-white/10 bg-slate-900/95 p-6 shadow-xl duration-200 sm:rounded-2xl',
      ...
      >
        {children}
        <DialogPrimitive.Close className="absolute right-4 top-4 rounded-full text-slate-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-purple-500/40">
          <X className="h-4 w-4" />
