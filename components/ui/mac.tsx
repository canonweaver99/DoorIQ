...
export function Mac({ width = 600, height = 500, src, videoSrc, videoRef, children, ...props }: MacProps) {
    ...
    >
      ...
      {videoSrc ? (
        <foreignObject x="29.12" y="25.02" width="541.76" height="305.06">
          <div style={{ width: '100%', height: '100%', backgroundColor: '#000', borderRadius: '0.44px', overflow: 'hidden' }}>
            <video
              ref={actualVideoRef}
              autoPlay
              loop
      ...
      <defs>
        ...
        >
          ...
          <stop offset="0.1" stopColor="#d1d3d4" />
          <stop offset="0.41" stopColor="#e6e7e8" />
          <stop offset="0.73" stopColor="#e6e7e8" />
