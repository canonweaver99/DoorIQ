...
const agents = [
  ...
  { name: "Austin", fullName: "Austin", src: "/Austin No Backround.png", color: "primary" },
...
interface ScrollingAgentCarouselProps {
  title?: string;
  description?: string;
...
export function ScrollingAgentCarousel({
  ...
  return (
    <div className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden bg-white dark:bg-black/5">
      <AnimatedGrid />
      ...
      {(ctaPrimaryHref || ctaSecondaryHref) && (
        <motion.div 
          className="absolute bottom-44 md:bottom-52 left-0 right-0 z-20 flex items-center justify-center gap-4 flex-wrap px-4"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
