-- Create messages table for rep-to-manager communication
...
-- Create a function to get conversation history between two users
...
-- Create a function to get latest conversations for a user
...
-- Create a function to update user's last seen timestamp
