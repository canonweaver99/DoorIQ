 ...
 * 
 * IMPORTANT: All prices MUST belong to product: prod_TmlX1S82Ed4Gpe
 * This is the only product ID that should be used.
 * 
 * Price IDs and Payment Links for DoorIQ Plans
 * Updated for production use
 */

// The single product ID that all prices must belong to
export const STRIPE_PRODUCT_ID = 'prod_TmlX1S82Ed4Gpe'
...
export const STRIPE_CONFIG = {
  starter: {
    ...
    // MUST belong to product: prod_TmlX1S82Ed4Gpe
