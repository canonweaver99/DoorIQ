...
// LEGACY ANALYTICS VIEW - Archived but functional
// This is the previous analytics page implementation
// Accessible at /analytics/[sessionId]/legacy
      ...
      <div className="max-w-5xl mx-auto px-6 pt-20 pb-12 space-y-10">
        <div className="flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
          <div className="space-y-2">
            ...
            <h1 className="text-3xl font-semibold text-white">AI-Powered Performance Analysis (Legacy)</h1>
            {session && (
              <p className="text-gray-500 text-sm">
