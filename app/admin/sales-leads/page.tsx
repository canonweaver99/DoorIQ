      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            <div>
              <h1 className="text-3xl font-space font-bold tracking-tight text-white mb-2">Sales CRM</h1>
              <p className="text-[#a0a0a0] font-sans leading-relaxed">Manage your sales pipeline and leads</p>
            </div>
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="px-4 py-2 bg-[#1a1a1a] border border-[#2a2a2a] text-white rounded-lg hover:bg-[#2a2a2a] transition-colors flex items-center gap-2"
              >
          ...
          {viewMode === 'pipeline' && (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              <div className="bg-[#1a1a1a] rounded-xl p-4 border border-[#2a2a2a] shadow-sm">
                <p className="text-sm text-[#a0a0a0] mb-1 font-sans">Total Pipeline Value</p>
                <p className="text-2xl font-space font-bold tracking-tight text-white">
                  ${totalPipelineValue.toLocaleString()}
                </p>
              </div>
              <div className="bg-[#1a1a1a] rounded-xl p-4 border border-[#2a2a2a] shadow-sm">
                <p className="text-sm text-[#a0a0a0] mb-1 font-sans">Weighted Value</p>
                <p className="text-2xl font-space font-bold tracking-tight text-white">
                  ${Math.round(totalWeightedValue).toLocaleString()}
                </p>
              </div>
              <div className="bg-[#1a1a1a] rounded-xl p-4 border border-[#2a2a2a] shadow-sm">
                <p className="text-sm text-[#a0a0a0] mb-1 font-sans">Active Leads</p>
                <p className="text-2xl font-space font-bold tracking-tight text-white">
                    ...
                    return (
                      <tr key={lead.id} className="hover:bg-[#0a0a0a] transition-colors">
                        ...
                        <td className="p-4">
                          <Link
                            href={`/admin/sales-leads/${lead.id}`}
                            className="text-purple-400 hover:text-purple-300 flex items-center gap-1 text-sm font-space font-medium"
                          >
