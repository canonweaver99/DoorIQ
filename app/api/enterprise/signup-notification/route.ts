...
export async function POST(request: NextRequest) {
  try {
    ...
    const emailHtml = `
      ...
      <html>
        ...
        <body>
          <div class="container">
            <div class="header">
              <h1 style="margin: 0; font-size: 24px;">New Enterprise Signup</h1>
            </div>
            <div class="content">
              <p style="font-size: 16px; margin-bottom: 24px;">A new enterprise signup has been submitted:</p>
              ...
              <div class="info-row">
                ...
                <div class="info-value">${planType.charAt(0).toUpperCase() + planType.slice(1)}</div>
              </div>
              
              ${estimatedMonthlyCost ? `
              <div class="info-row">
                <div class="info-label">Estimated Monthly Cost</div>
                <div class="info-value">$${estimatedMonthlyCost.toLocaleString()}/month</div>
              </div>
              ` : ''}
              ...
              <div class="highlight">
                ...
                The user has booked a demo through Cal.com. Check your calendar for the scheduled meeting.
              </div>
            ...
            <div class="footer">
              <p>DoorIQ Enterprise Signup Notification</p>
            </div>
          </div>
        </body>
      </html>
    ...
    const { data, error } = await resend.emails.send({
      from: fromEmail,
      to: adminEmail,
      subject: `New Enterprise Signup: ${organizationName}`,
      html: emailHtml,
    ...
    console.error('Error sending enterprise signup email:', error)
    return NextResponse.json(
