 ...
 * Update organization seat limits (for organization managers/admins)
...
export async function PATCH(
  ...
  try {
    ...
    // Check if user belongs to this organization and is manager/admin
    if (userData.organization_id !== id || !['manager', 'admin'].includes(userData.role)) {
